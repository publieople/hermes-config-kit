...
trigger: TDD|测试驱动|写测试|red green refactor
...
**Retrofitting tests to existing code?** See `references/characterization-tests.md` — when code already exists and works, trust the code first. If a characterization test fails, suspect the test is wrong, not the code.
