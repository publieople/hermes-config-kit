...
### Dark Tech / CRT
* **CRT Scanlines** — Subtle horizontal line overlay at 3-4px spacing, 3-6% opacity
* **Dot Grid** — Radial-gradient dot matrix with radial mask fade
* **Title Glow Pulse** — Layered text-shadow breathing animation
* **Neon Conic Border** — Rotating conic-gradient card border, blurred glow + sharp ring
* **Implementation:** `references/dark-tech-crt-patterns.md` — CSS snippets, keyframes, pitfalls
